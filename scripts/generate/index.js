...
const main = async () => {
    ...
    const packageInfo = produce(
        ...
        info => {
            ...
            info.name = `@chooks/${answers.packageName}`;
            info.homepage = `https://github.com/ChocolateUI/chocolate-hooks/tree/master/packages/${answers.packageName}`;
            ...
            if (answers.hookTest) {
                ...
                info.scripts.test = `echo 'No test in @chooks/${answers.packageName}'`;
            }
